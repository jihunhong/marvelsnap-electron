...
exports.getUser = function(profileId) {
    return new Promise((resolve, reject) => {
        axios.get(`https://api.snapsco.net/api/collections/user_collection/record?filter=(profileId="${profileId}")&perPage=1`)
            .then(response => {
...
exports.update = function(id, profileId, cards) {
    return new Promise((resolve, reject) => {
        axios
            .post(`https://api.snapsco.net/api/collections/user_collection/records/${id}`, {
                profileId,
